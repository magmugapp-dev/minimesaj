...
it('renders the redesigned ai studio pages for an admin', function () {
    ...
    $this->actingAs($admin)
        ...
        ->assertSeeText('AI Wizard')
        ->assertSeeText('Temel Kimlik')
        ->assertSeeText('Profil ve Kisilik')
        ->assertSeeText('Mesaj Davranisi')
        ->assertSeeText('Limitler ve Model')
        ->assertSeeText('Tekrar Yazma ve Ozet')
        ->assertSeeText('Character ID')
        ->assertSeeText('Kadin karakter olarak davranir')
        ->assertSeeText('Erkek karakter olarak davranir')
        ->assertSeeText('Belirtmek istemeyen veya notr karakter')
