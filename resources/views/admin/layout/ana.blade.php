        ...
        <nav data-admin-sidebar-nav class="flex-1 overflow-y-auto px-3 py-4">
            ...
            @php
                ...
                $moderasyonMenuler = [
                    ...
                    [
                        'route' => 'admin.moderasyon.ai-olaylari',
                        'etiket' => 'AI Olaylari',
                        'svg' =>
                            '<path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.75h4.5m-8.25 4.5h12m-10.5 0v9A2.25 2.25 0 009.75 19.5h4.5A2.25 2.25 0 0016.5 17.25v-9m-8.25 3.75h7.5m-7.5 3h7.5"/>',
                    ],
                    [
                ...
                $finansalMenuler = [
                    ...
                    [
                        ...
                        'etiket' => 'Gemini',
                        'svg' =>
                            '<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18 3.75l.517 1.594a2.25 2.25 0 001.423 1.423L21.75 7.5l-1.81.733a2.25 2.25 0 00-1.423 1.423L18 11.25l-.517-1.594a2.25 2.25 0 00-1.423-1.423L14.25 7.5l1.81-.733a2.25 2.25 0 001.423-1.423L18 3.75z"/>',
                    ],
                    [
                ...
                $sistemMenuler = [
                    ...
                    [
                        'route' => 'admin.dil-metin.index',
                        'etiket' => 'Dil ve Metin',
                        'svg' =>
                            '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 21l5.25-11.25L21 21m-8.25-4.5h5.25M3 5.25h11.25M6.75 3v2.25m3 0C8.875 8.625 6.75 11.25 3 12.75m3.75-7.5c.75 2.625 2.625 5.25 6.75 7.5"/>',
                    ],
                ];
            @endphp
            ...
            @foreach ($menuler as $menu)
                @php
                    $aktif = Route::has($menu['route']) &&
                        ($menu['route'] === 'admin.ai.index'
