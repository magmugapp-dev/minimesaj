...
@section('baslik', 'Yeni AI Kullanıcısı')
            ...
            <form method="POST" action="{{ route('admin.ai.kaydet') }}" class="studio-main">
                ...
                <section id="kimlik" class="studio-card scroll-mt-24">
                    ...
                    <div class="studio-form-grid studio-form-grid--2">
                        ...
                        <div>
                            <label class="studio-label" for="kullanici_adi">Kullanıcı adı</label>
                            <input id="kullanici_adi" type="text" name="kullanici_adi" value="{{ old('kullanici_adi') }}" required class="studio-input" placeholder="burcin_ai">
                        </div>
                        <div>
                ...
                <section class="studio-card">
                    <div class="studio-actions">
                        ...
                        <div class="studio-actions__buttons">
                            <a href="{{ route('admin.ai.index') }}" class="studio-button studio-button--ghost">Vazgeç</a>
                            <button type="submit" class="studio-button studio-button--primary">AI kullanıcısını oluştur</button>
                        </div>
                    </div>
                </section>
            </form>
            ...
            <aside class="studio-sidebar">
                ...
                <section class="studio-card">
                    <div class="studio-stack mt-4">
                        ...
                        <a href="{{ route('admin.ai.json-ekle') }}" class="studio-linkcard">
                            <span>Toplu JSON ekle</span>
                            <svg class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m9 18 6-6-6-6" />
                            </svg>
                        </a>
