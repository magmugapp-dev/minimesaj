...
@section('baslik', 'Influencer JSON Import')
...
@section('icerik')
    <div class="studio studio--ai space-y-6" x-data="{ sayi: 0 }">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <h1 class="text-2xl font-semibold text-slate-950">JSON ile toplu influencer ekle</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admin.influencer.json-kaydet') }}" class="studio-card">
            @csrf
            ...
            <label>
                ...
                <textarea id="jsonAlani" name="json_veri" rows="20"
                    placeholder="JSON formatinda influencer verilerini buraya yapistirin..."
            ...
            <div class="studio-actions mt-6">
                <div class="studio-actions__buttons">
                    <a href="{{ route('admin.influencer.ekle') }}" class="studio-button studio-button--ghost">Tekli Olusturma</a>
